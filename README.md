...
**v0.3.3 / build 8：开发预览。** 恢复提示现在明确区分“保持静音，不再提醒”和临时关闭；两个操作按钮保持等宽。恢复提醒仍默认关闭。尚未完成全部设备、辅助功能权限和长期性能实机验收，具体证据及限制见[测试报告](docs/TESTING.md)。

上图为 v0.2.0 实机截图。以下为 v0.3.3 使用模拟数据生成的原生恢复提示预览：

![播放时恢复音量提示](docs/assets/v0.3.3/recovery-prompt-dark.png)
...
![恢复提醒设置](docs/assets/v0.3.3/settings-recovery.png)
![恢复提示浅色外观](docs/assets/v0.3.3/recovery-prompt-light.png)
![关于](docs/assets/v0.3.3/about.png)
